...
//   2. unsigned char array where, if bit k is set in the first array, [k] in
//      the second array is a rarealt dosage count (1..255).  If bit k is unset
//      in the first array, the second array [k] value is meaningless (does not
//      need to be zero).
...
//         values.
//      The payload values are packed at the beginning, for better memory
//      access locality.  (Resorting algorithm: initialize an array of
//      uintptr_ts of length sample_ct where [k] has that sample's start index
//      in the payload arrays.)
